...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createTocken(@RequestBody AuthenticationRequest request) {

        try{
            authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(request.getUsername(), request.getPassword()));
            UserDetails userDetails = projectUserDetailsService.loadUserByUsername(request.getUsername());
